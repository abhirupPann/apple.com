...
//-------Fetching Scroll Position For GlassMorphism Effect------ 
  ...
  return (
    <div className={`m-auto flex px-auto justify-center items-center  ${scrollPosition===0 ? "bg-white": "backdrop-blur-3xl bg-white/70"} fixed w-screen `}>
      <ul className='flex gap-8 justify-center items-center font-sf text-[0.7rem] py-[0.2vh]'>
        <li className=' cursor-pointer'><svg height="44" viewBox="0 0 14 44" width="14" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className=' cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" width="15px" height="44px" viewBox="0 0 15 44">
